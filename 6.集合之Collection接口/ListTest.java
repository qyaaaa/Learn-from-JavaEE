 ...
 *              |----ArrayList：作为List接口的主要实现类，线程不安全的，效率搞，底层使用Object【】 elementData存储
 ...
 *          ...
 *          list.add(11);//如果此次的添加导致底层elementData数组容量不够，则扩容。默认情况下，扩容为原来的容量的1.5倍，
 ...
 *          .。。
 *          后续的添加扩容与jdk7相同
 *          2.3小结：jdk7中的ArrayList的对象的创建类型于单例的饿汉式
